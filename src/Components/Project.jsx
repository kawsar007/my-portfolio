  ...
  const [state] = useState([
    {
      ...
      text: "It's amazing app Search Github User.Login, Logout functionalities & Mobile responsive. User can be search all github users details. ",
        technology: "Technology Used: HTML, CSS, Material-UI, React,Context Api, React Router, Chart.js",
        projectLink:
    ...
    },
    {
      ...
      text:
        "This is Startup Company Landing Page, Business Website fully mobile responsive design.", 
        technology: "Technology Used: HTML, CSS, Next js, React, theme-ui, react-scroll, react-multi-carousel etc.",
    ...
    },
    {
      ...
      text:
        "Starwars API Build website Design using NextJs Static Site Generate(SSG) & Dynamic Routes.",
    ...
    },
    {
      ...
      text:
        "This is awesome Netflix Clone App using realtime database TMDB API. User can watching movie trailer.",
